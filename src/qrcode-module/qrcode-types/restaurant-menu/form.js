...
export class QRCGRestarutantMenuForm extends BaseTypeForm {
    static styles = [
        super.styles,
        css`
            qrcg-form-section {
    ...
    render() {
        return html`
            <qrcg-form-comment>
                ${t`Create your digital menu easily, no design skills are required.`}
            </qrcg-form-comment>
            <qrcg-form>
                <qrcg-form-section>
                    <h2 class="section-title">${t`Restaurant Details`}</h2>
                    <qrcg-input
...
window.defineCustomElement('qrcg-restaurant-menu-form', QRCGRestarutantMenuForm)
