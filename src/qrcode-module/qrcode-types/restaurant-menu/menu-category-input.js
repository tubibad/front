...
import { QrcgRestaurantMenuCategoryModal } from './menu-category-modal'

export class QrcgMenuCategoryInput extends LitElement {
    static styles = [
        css`
            :host {
                display: block;
    ...
    async onEditMenuCategoryClick(button) {
        ...
        try {
            const category = await this.openMenuCategoryModal(data)
    ...
    openMenuCategoryModal(data) {
        return QrcgRestaurantMenuCategoryModal.open({
            data,
    ...
    async openModal() {
        try {
            const category = await this.openMenuCategoryModal()
    ...
    renderEmptyCategoriesMessage() {
        ...
        return html`
            <div class="empty-message">
                ${t`There are no menu categories. Click on Add Category button below.`}
            </div>
        `
    }
