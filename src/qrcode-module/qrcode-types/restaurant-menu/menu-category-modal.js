...
export class QrcgRestaurantMenuCategoryModal extends QrcgModal {
    static styles = [
        super.styles,
        css`
            :host {
    ...
    static open({ data, categories } = {}) {
        const modal = new QrcgRestaurantMenuCategoryModal()
    ...
    renderBody() {
        return html`
            <div class="content-view">
                <qrcg-input name="name" placeholder=${t`Breakfast`} required>
                    ${t`Category Name`}
                </qrcg-input>

                <qrcg-input
                    name="servingHours"
                    placeholder=${t`Serving Hours (Optional)`}
                >
                    ${t`Serving Hours`}
                </qrcg-input>
...
window.defineCustomElement(
    'qrcg-restarurant-menu-category-modal',
    QrcgRestaurantMenuCategoryModal
)
