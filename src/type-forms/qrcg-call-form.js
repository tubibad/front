...
class QRCGCallForm extends LitElement {
    ...
    render() {
        return html`
            <qrcg-form-comment>
                ${t`Receive phone calls after scanning the QR code.`}
            </qrcg-form-comment>

            <qrcg-form>
                <qrcg-input name="phone" placeholder="${t`your phone number`}">
                    ${t`Phone number`}
                </qrcg-input>
...
window.defineCustomElement('qrcg-call-form', QRCGCallForm)
